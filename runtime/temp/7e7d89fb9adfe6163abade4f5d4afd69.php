<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"F:\www\www.longfu.com\longfu\public/../application/admin\view\team\tianjia.html";i:1552796908;s:65:"F:\www\www.longfu.com\longfu\application\admin\view\pub\head.html";i:1552796908;s:72:"F:\www\www.longfu.com\longfu\application\admin\view\team\js_tianjia.html";i:1552796908;s:65:"F:\www\www.longfu.com\longfu\application\admin\view\pub\foot.html";i:1552796908;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="edit">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*职位</span>：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="fsd" name="title">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>职位简介：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder=""  name="profile">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>毕业院校：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder=""  name="school">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>座右铭：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder=""  name="motto">
			</div>
		</div>


		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>获得学位：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder=""  name="degree">
			</div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">人物图：</label>
			<!--上传图片插件按钮容器-->
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">职业经历：</label>
